...
testthat::test_that(
  "Tests on MODIStsp", {
    ...
    # cat("(skipped)\n")
      MODIStsp(gui = FALSE,
               options_file = "D:/Documents/Source/git/MODIStsp/inst/Test_files/test04_LB.json") #nolint
    ...
    # cat("(skipped)\n")
    MODIStsp(gui = FALSE,
             options_file = "D:/Documents/Source/git/MODIStsp/inst/Test_files/test05_LB.json")
    # MODIStsp(test = 5)
