...
MODIStsp_GUI_tcl <- function(general_opts,
  ...
  gWidgets::font(prod_label) <- gWidgets::font(cat_label) <- list(
    family = "sans", weight = "bold", size = "small", size = "small")
      ...
      if (!is.null(check_names_indexes)) {
        ...
        wids$band_newindex  <- gbutton(
          ...
          handler = function(h, ...) {
            ...
            addind <- MODIStsp_addindex(opts_jsfile   = opt_jsfile,
  ...
  gWidgets::font(vers_label) <- list(family = "sans", weight = "bold", size = "small")
  gWidgets::font(sens_label) <- gWidgets::font(band_label) <- list(
    family = "sans", weight = "bold", size = "small")
  ...
  gWidgets::font(method_lab) <- list(family = "sans", weight = "bold", size = "small")
  gWidgets::font(user_lab)   <- gWidgets::font(password_lab) <-
    list(family = "sans", weight = "bold", size = "small")
  ...
  gWidgets::font(seas_lab) <- list(family = "sans", weight = "bold", size = "small")
  ...
  gWidgets::font(bounding_group) <- list(family = "sans", weight = "bold", size = "small")
  ...
  gWidgets::font(output_proj_lab) <- list(family = "sans", weight = "bold", size = "small")
  ...
  gWidgets::font(output_res_lab) <- list(family = "sans", weight = "bold", size = "small")
  ...
  pixsize_lab       <- glabel(text      = "  Pixel Size:",
                              container = output_res_group)
  gWidgets::font(pixsize_lab) <- list(family = "sans", weight = "bold", size = "small")
  ...
  resmeth_lab       <- glabel(text      = "    Resampling Method:  ",
                              container = output_res_group)
  gWidgets::font(resmeth_lab) <- list(family = "sans", weight = "bold", size = "small")
  ...
  format_lab       <- glabel(text      = "Output Files Format:",
                             container = opt_group)
  gWidgets::font(format_lab) <- list(family = "sans", weight = "bold", size = "small")
  ...
  gWidgets::font(compress_lab)   <- list(family = "sans", weight = "bold", size = "small")
  ...
  timeseries_lab       <- glabel(text      = "Create Virtual Rasters:",
                                 container = opt_group)
  gWidgets::font(timeseries_lab) <- list(family = "sans", weight = "bold", size = "small")
  ...
  wids$rts     <- gradio(items      = c("Yes", "No"),
                         ...
                         horizontal = TRUE)
  gWidgets::font(rts_lab) <- list(family = "sans", weight = "bold", size = "small")
  ...
  wids$nodata <- gradio(items      = c("Yes", "No"),
                        ...
                        selected   = match(general_opts$nodata_change,
                                           c("Yes", "No")),
                        horizontal = TRUE)
  gWidgets::font(nodata_lab) <- list(family = "sans", weight = "bold", size = "small")
  ...
  wids$scale <- gradio(items      = c("Yes", "No"),
                       ...
                       selected   = match(general_opts$scale_val,
                                          c("Yes", "No")),
                       horizontal = TRUE)
  gWidgets::font(scale_lab) <- list(family = "sans", weight = "bold", size = "small")
  ...
  delete_lab       <- glabel(text      = "Delete original HDF files: ",
                             container = outfoldmod_group)
  gWidgets::font(delete_lab) <- list(family = "sans", weight = "bold", size = "small")
  ...
  reprocess_lab       <- glabel(text = "ReProcess Existing Data: ",
                                container = outfold_group)
  gWidgets::font(reprocess_lab) <- list(family = "sans", weight = "bold", size = "small")
