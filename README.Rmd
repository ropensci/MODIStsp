...
- We recently fixed a bug affecting MODIS layers coded as Unsigned Integer - 32 bit (Thanks to Rob Critchlow for signaling this). The bug was due to improper handling of UInt32 data in `gdalbuildvrt`, 
causing sometimes an incorrect translation from HDF to output formats (see https://github.com/lbusett/MODIStsp/issues/72). 
...
- MCD43A2: BRDF_Albedo_Band_Quality (V005 and V006)
