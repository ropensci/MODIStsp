...
**IMPORTANT:** _MODIStsp_ requires [R](http://cran.r-project.org) v >= 3.2.1 and [GDAL](https://www.gdal.org) (Geospatial Data Abstraction Library) v >= 1.11.1 To be installed in your system. Brief instructions for installing R and GDAL can be found [HERE](#gdal_inst).
