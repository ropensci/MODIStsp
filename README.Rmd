...
the CLI, by allowing to set all processing arguments also from the CLI. __NOTE__ due to the 
...
contained in the options file with new values. This allows to easily run 
