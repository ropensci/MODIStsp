...
```{r select_gui, echo=FALSE,  fig.align="center", fig.width=10, message=FALSE, warning=FALSE}
  library(png)
  library(grid)
...
```{r select_layers, echo=FALSE, fig.align="center", fig.width=10, message=FALSE, warning=FALSE}
  library(png)
  library(grid)
...
```{r select_index, echo=FALSE, fig.align="center", fig.height=1.5}
  library(png)
  library(grid)
