...
-   We discovered a bug recently introduced on *ftp* download. If you recently installed `MODIStsp`, please delete your current version and re-install ! Sorry for the trouble !
