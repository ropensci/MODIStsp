...
**NOTE:** There seem to be some problems in installing MODIStsp via install_github on R 3.3.1 due to not correct installation of dependencies (probably related to a install_github problem ? ). We are working to understand the issue ! 
