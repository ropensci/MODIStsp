...
An extended description of MODIStsp functionalities is provided in the [package vignette](https://github.com/lbusett/MODIStsp/tree/devel/inst/doc) (_Click on "Raw" at the beginning of the document to download the pdf file_) 
