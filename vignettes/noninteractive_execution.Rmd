...
# <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i> __Specifying a saved "Options file"__
...
# <i class="fa fa-arrow-circle-o-right" aria-hidden="true"></i> __Looping on different spatial extents__
...
# --> Loop on the list of spatial files and run MODIStsp using each of them to automatically define the output extent (A separate output folder is created for each input spatial file).
