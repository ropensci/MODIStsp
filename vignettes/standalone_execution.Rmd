...
- In a Linux operating system this function creates a desktop entry (accessible from thea menu in the sections "Science" and "Geography") and a symbolic link in a known path (default: /usr/bin/MODIStsp).
