...
To be able to do that, from R launch the function `MODIStsp_install_launcher()`.
...
- add the path of the MODIStsp.bat launcher as Action (point 6), specifying  `-g -s "X:/yourpath/youroptions.RData"` as argument.
