---
title: 'MODIStsp: A Tool for Automatic Preprocessing of MODIS Time Series - v1.3.9'
...
3. If nothing works, signal it in the [issues](https://github.com/ropensci/MODIStsp/issues)
...
1.  **Select MODIS Tiles**: specify which MODIS tiles need to be processed either by: 
    ...
    b. clicking the __"Select on Map"__ button. A map will open in a browser window,
...
either by: 
    ...
    b. clicking the __"Load Extent from a Spatial File" and selecting a raster or 
    ...
    c. clicking the __"Select on Map"__ button. A map will open in a browser window,
    allowing interactive selection of the spatial extent using the tools on the left.
    
    
**Note: ** clicking the "show current extent" will open a browser window highlighting
...
(see also https://ropensci.github.io/MODIStsp/articles/output.html).
...
All `MODIStsp` outputs **will be placed in specific sub-folders of this main folder** (see https://ropensci.github.io/MODIStsp/articles/output.html for details on `MODIStsp` 
naming conventions)-.
...
https://ropensci.github.io/MODIStsp/articles/faq.html
