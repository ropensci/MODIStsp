...
author: "Lorenzo Busetto ([busetto.l@irea.cnr.it](mailto:busetto.l@irea.cnr.it)), Luigi  Ranghetti'
  ([ranghetti.l@irea.cnr.it](mailto:ranghetti.l@irea.cnr.it))"
date: '`r Sys.Date()`'
output:
  pdf_document:
    fig_caption: yes
...
|---------------|-------------|------------------------------|
| gWidgetsRGtk2 | >= 0.0-54   | [@gwid]   |
| rgdal         | >= 0.8-16   | [@rgdal]         |
| plyr          | >= 1.8.3    | [@Wickham2011]               |
| gdalUtils     | >= 2.0.1.7    | [@gutils] |
...
```{r fig.width=7, fig.height=7, fig.cap = "The MODIStsp main GUI",echo=FALSE}
  library(png)
  library(grid)
  img <- readPNG('D:/Documents/GDrive/My Files/MODIS_Paper/Latex_RSL/Figure_2.png')
  grid.raster(img)
  library(knitr)
...
```{r fig.width = 7,  fig.height = 3, fig.cap = 'The "Select Processing Layers" GUI',echo=FALSE}
  library(png)
  library(grid)
  img <- readPNG('D:/Documents/GDrive/My Files/MODIS_Paper/Latex_RSL/Figure_3.png')
  grid.raster(img)
```
