---
title: 'MODIStsp: A tool for automatic preprocessing of MODIS time series - v1.3.0'
...
The **use_aria2c** option allows to accelerate the download from NASA archives, provided that the "aria2c" software is installed in your system. To download it and install it, see: [https://aria2.github.io/](aria2.github.io/)
