...
_MODIStsp_ was developed completely in the "R" Language and Environment for Statistical Computing (R Development Core Team 2014) v. 3.1.3 and is distributed as open source software under the GNU-GPL 3.0 License. Source code can be downloaded at the GITHUB repository https://github.com/lbusett/MODIStsp.
...
<center>**Table I: List of "R" package dependencies for the MODIStsp tool.**</center>
...
\pagebreak
```{r fig.width = 5,  fig.height = 2, fig.cap = 'The GUI for insertion of additional Spectral Indexes',echo=FALSE}
  library(png)
  library(grid)
  img <- readPNG('Figure_SI.png')
  grid.raster(img)
```
...
2. If it is installed but not found try consulting the _MODIStsp_ FAQ section for possible solutions
