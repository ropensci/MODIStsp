---
title: 'MODIStsp: A Tool for Automatic Preprocessing of MODIS Time Series - v2.0.0'
...
vignette: >
  ...
  %\VignetteIndexEntry{MODIStsp: A Tool for Automatic Preprocessing of MODIS Time Series - v2.0.0}
...
The other parameters are set automatically to default values (see XXX for details on the different available function arguments). 
