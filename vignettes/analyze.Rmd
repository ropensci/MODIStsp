...
```{r eval=TRUE, echo=TRUE, message=TRUE, warning=TRUE, paged.print=FALSE}
library(MODIStsp)
...
If you want to save them elsewhere, run `MODIStsp(options_file = opts_file, gui = TRUE)`
and select a different ouput folder).
