...
- __Download the newest source file for RGtk2__ from https://cran.r-project.org/web/packages/RGtk2/index.html.
...
then, check again to see if hdf4 is supporterd. The list should now include hdf4: 
